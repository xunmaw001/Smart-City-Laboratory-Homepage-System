    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所在位置" prop="suozaiweizhi">
          <el-input v-model="ruleForm.suozaiweizhi" 
              placeholder="所在位置" clearable  :readonly="ro.suozaiweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所在位置" prop="suozaiweizhi">
              <el-input v-model="ruleForm.suozaiweizhi" 
                placeholder="所在位置" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="使用情况" prop="shiyongqingkuang">
          <el-select v-model="ruleForm.shiyongqingkuang" placeholder="请选择使用情况">
            <el-option
                v-for="(item,index) in shiyongqingkuangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="使用情况" prop="shiyongqingkuang">
	      <el-input v-model="ruleForm.shiyongqingkuang"
                placeholder="使用情况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.shiyongqingkuangOptions = "使用中,未使用".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.shebeixiangqing = this.ruleForm.shebeixiangqing.replace(reg,'../../../ssmm73am/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
