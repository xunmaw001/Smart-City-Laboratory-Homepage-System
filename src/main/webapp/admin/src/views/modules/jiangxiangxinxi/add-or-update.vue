<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="奖项说明" prop="jiangxiangshuoming">
          <el-input v-model="ruleForm.jiangxiangshuoming" 
              placeholder="奖项说明" clearable  :readonly="ro.jiangxiangshuoming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="奖项说明" prop="jiangxiangshuoming">
              <el-input v-model="ruleForm.jiangxiangshuoming" 
                placeholder="奖项说明" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="评比时间" prop="pingbishijian">
          <el-input v-model="ruleForm.pingbishijian" 
              placeholder="评比时间" clearable  :readonly="ro.pingbishijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="评比时间" prop="pingbishijian">
              <el-input v-model="ruleForm.pingbishijian" 
                placeholder="评比时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.leibie = true;
          ...
          if(o=='jiangxiangshuoming'){
            this.ruleForm.jiangxiangshuoming = obj[o];
	    this.ro.jiangxiangshuoming = true;
            continue;
          }
          if(o=='pingbishijian'){
            this.ruleForm.pingbishijian = obj[o];
	    this.ro.pingbishijian = true;
            continue;
          }
          if(o=='beizhu'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiangxiangxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiangxiangxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
