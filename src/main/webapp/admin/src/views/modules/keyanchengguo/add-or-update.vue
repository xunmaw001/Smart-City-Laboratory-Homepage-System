<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="研究团队" prop="yanjiutuandui">
          <el-input v-model="ruleForm.yanjiutuandui" 
              placeholder="研究团队" clearable  :readonly="ro.yanjiutuandui"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="研究团队" prop="yanjiutuandui">
              <el-input v-model="ruleForm.yanjiutuandui" 
                placeholder="研究团队" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="技术简介" prop="jishujianjie">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="技术简介"
                  v-model="ruleForm.jishujianjie" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jishujianjie" label="技术简介" prop="jishujianjie">
                    <span>{{ruleForm.jishujianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="应用范围" prop="yingyongfanwei">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="应用范围"
                  v-model="ruleForm.yingyongfanwei" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yingyongfanwei" label="应用范围" prop="yingyongfanwei">
                    <span>{{ruleForm.yingyongfanwei}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiangmumingcheng = true;
          ...
          if(o=='jishujianjie'){
            this.ruleForm.jishujianjie = obj[o];
	    this.ro.jishujianjie = true;
            continue;
          }
          if(o=='yingyongfanwei'){
            this.ruleForm.yingyongfanwei = obj[o];
	    this.ro.yingyongfanwei = true;
            continue;
          }
          if(o=='baogaowenjian'){
	    ...
	    this.ro.baogaowenjian = true;
          ...
          if(o=='yanjiutuandui'){
            this.ruleForm.yanjiutuandui = obj[o];
	    this.ro.yanjiutuandui = true;
            continue;
          }
          if(o=='faburiqi'){
