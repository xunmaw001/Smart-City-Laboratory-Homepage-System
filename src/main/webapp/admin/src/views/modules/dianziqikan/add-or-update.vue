<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="杂志名称" prop="zazhimingcheng">
          <el-input v-model="ruleForm.zazhimingcheng" 
              placeholder="杂志名称" clearable  :readonly="ro.zazhimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="杂志名称" prop="zazhimingcheng">
              <el-input v-model="ruleForm.zazhimingcheng" 
                placeholder="杂志名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所属分类" prop="suoshufenlei">
          <el-input v-model="ruleForm.suoshufenlei" 
              placeholder="所属分类" clearable  :readonly="ro.suoshufenlei"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="附件下载" prop="fujianxiazai">
          <file-upload
          tip="点击上传附件下载"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fujianxiazai" label="附件下载" prop="fujianxiazai">
            <el-button type="text" size="small" @click="download(ruleForm.fujianxiazai)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发行单位" prop="faxingdanwei">
          <el-input v-model="ruleForm.faxingdanwei" 
              placeholder="发行单位" clearable  :readonly="ro.faxingdanwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发行单位" prop="faxingdanwei">
              <el-input v-model="ruleForm.faxingdanwei" 
                placeholder="发行单位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.bianhao = true;
          ...
          if(o=='zazhimingcheng'){
            this.ruleForm.zazhimingcheng = obj[o];
	    this.ro.zazhimingcheng = true;
            continue;
          }
          if(o=='suoshufenlei'){
	    ...
	    this.ro.fujianxiazai = true;
          ...
          if(o=='faxingdanwei'){
            this.ruleForm.faxingdanwei = obj[o];
	    this.ro.faxingdanwei = true;
            continue;
          }
          if(o=='faburiqi'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `dianziqikan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.dianziqikanCrossAddOrUpdateFlag = false;
                  this.parent.search();
