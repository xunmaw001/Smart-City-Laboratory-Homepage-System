<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="团队人数" prop="tuanduirenshu">
          <el-input v-model="ruleForm.tuanduirenshu" 
              placeholder="团队人数" clearable  :readonly="ro.tuanduirenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="团队人数" prop="tuanduirenshu">
              <el-input v-model="ruleForm.tuanduirenshu" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaoshixingming = true;
          ...
          if(o=='tuanduirenshu'){
            this.ruleForm.tuanduirenshu = obj[o];
	    this.ro.tuanduirenshu = true;
            continue;
          }
          if(o=='banji'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xueshutuandui/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xueshutuanduiCrossAddOrUpdateFlag = false;
                  this.parent.search();
