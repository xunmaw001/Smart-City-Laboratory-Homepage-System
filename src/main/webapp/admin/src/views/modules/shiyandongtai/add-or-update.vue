<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实验名称" prop="shiyanmingcheng">
          <el-input v-model="ruleForm.shiyanmingcheng" 
              placeholder="实验名称" clearable  :readonly="ro.shiyanmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="实验名称" prop="shiyanmingcheng">
              <el-input v-model="ruleForm.shiyanmingcheng" 
                placeholder="实验名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实验团队" prop="shiyantuandui">
          <el-input v-model="ruleForm.shiyantuandui" 
              placeholder="实验团队" clearable  :readonly="ro.shiyantuandui"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="实验团队" prop="shiyantuandui">
              <el-input v-model="ruleForm.shiyantuandui" 
                placeholder="实验团队" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="进展情况" prop="jinzhanqingkuang">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jinzhanqingkuang" label="进展情况" prop="jinzhanqingkuang">
                    <span>{{ruleForm.jinzhanqingkuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jinzhanqingkuang = true;
          ...
          if(o=='shiyantuandui'){
            this.ruleForm.shiyantuandui = obj[o];
	    this.ro.shiyantuandui = true;
            continue;
          }
          if(o=='fabushijian'){
	...
	this.ruleForm.shiyanneirong = this.ruleForm.shiyanneirong.replace(reg,'../../../ssmm73am/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shiyandongtai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shiyandongtaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
