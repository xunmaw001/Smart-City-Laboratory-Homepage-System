<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="参与人员" prop="canyurenyuan">
          <el-input v-model="ruleForm.canyurenyuan" 
              placeholder="参与人员" clearable  :readonly="ro.canyurenyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="参与人员" prop="canyurenyuan">
              <el-input v-model="ruleForm.canyurenyuan" 
                placeholder="参与人员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="活动对象" prop="huodongduixiang">
          <el-input v-model="ruleForm.huodongduixiang" 
              placeholder="活动对象" clearable  :readonly="ro.huodongduixiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="活动对象" prop="huodongduixiang">
              <el-input v-model="ruleForm.huodongduixiang" 
                placeholder="活动对象" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.canyurenyuan = true;
          ...
          if(o=='huodongduixiang'){
            this.ruleForm.huodongduixiang = obj[o];
	    this.ro.huodongduixiang = true;
            continue;
          }
          if(o=='huodongshijian'){
