<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="研究内容" prop="yanjiuneirong">
          <el-input v-model="ruleForm.yanjiuneirong" 
              placeholder="研究内容" clearable  :readonly="ro.yanjiuneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="研究内容" prop="yanjiuneirong">
              <el-input v-model="ruleForm.yanjiuneirong" 
                placeholder="研究内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.leixing = true;
          ...
          if(o=='yanjiuneirong'){
            this.ruleForm.yanjiuneirong = obj[o];
	    this.ro.yanjiuneirong = true;
            continue;
          }
          if(o=='fujian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `keyanbaogao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.keyanbaogaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
